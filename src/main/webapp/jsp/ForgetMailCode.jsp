...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-push-8">
            ...
            <!-- Start Sign In Form -->
            <form action="doVerificationCode.jsp" name="form" class="fh5co-form animate-box" data-animate-effect="fadeInRight" method="post">
                <h2>输入邮箱验证码</h2>
                <div class="form-group">
                    <input type="text" class="form-control" name="userLoginPassword" placeholder="验证码" autocomplete="off">
                </div>
                <div class="form-group">
                    <input type="submit" value="确认" onclick="return onCheck()" class="btn btn-primary"/>
                </div>
            </form>
            <!-- END Sign In Form -->
