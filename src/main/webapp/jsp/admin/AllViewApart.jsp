...
font-size: 16px;"><a href="../DoOperation/doAnminOut.jsp" class="btn btn-danger square-btn-adjust">退出</a> </div>
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            ...
            <button type="submit" class="btn btn-default">查看所有租房</button>
            <table class="table table-bordered">
                <caption>租房列表</caption>
                <thead>
                <tr>
                ...
                <tbody>
                <%
                    ArrayList<RentHouse> rentHouses = rentHouseDao.getAllRentHouse();
                    for (int i =0;rentHouses!=null&&rentHouses.size()>i;i++){
                        rentHouse = rentHouses.get(i);
                %>
                <tr>
                    <td><%=rentHouse.getRentHouseId()%></td>
                    <td><%=rentHouse.getRentHouseName()%></td>
