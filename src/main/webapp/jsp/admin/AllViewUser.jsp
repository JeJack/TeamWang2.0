...
font-size: 16px;"> <a href="../DoOperation/doAnminOut.jsp" class="btn btn-danger square-btn-adjust">退出</a> </div>
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            ...
            <button class="btn btn-default"><a href="AllViewUser.jsp">查看所有用户</a></button>
            <table class="table table-bordered">
                <caption>用户列表</caption>
                <thead>
                <tr>
                ...
                <tbody>
                <%
                    ArrayList<Users> usersArrayList = usersDao.getAllUsers();
                    for (int i =0;usersArrayList!=null&&usersArrayList.size()>i;i++){
                %>
                <tr>
                    <td><%=usersArrayList.get(i).getUserId()%></td>
                    <td><%=usersArrayList.get(i).getUserName()%></td>
                    <td><%=usersArrayList.get(i).getUserNickname()%></td>
                    <td><%=usersArrayList.get(i).getUserEmail()%></td>
                </tr>
                <%}%>
                </tbody>
            </table>
