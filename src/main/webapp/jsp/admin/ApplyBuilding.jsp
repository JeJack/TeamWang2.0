        ...
        <div id="page-inner">
            ...
            <table class="table table-bordered">
                ...
                <%
                    ...
                    ArrayList<UserApply> userApplies = userApplyDao.getUserApplyByBuildingId(id);
                ...
                <tr>
                    ...
                    <td><%=buildingDao.getBuildingById(userApplies.get(i).getCategoryId()).getBuildingPrice()%></td>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                <%
                    ArrayList<UserApply> userApplies1 = userApplyDao.getAllApplyBuilding();
                ...
                <tr>
                    ...
                    <%if (buildingDao.getBuildingById(userApplies1.get(all).getCategoryId())!=null){
                    %>
