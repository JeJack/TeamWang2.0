        ...
        <div id="page-inner">
            ...
            <table class="table table-bordered">
                ...
                <%
                    ...
                    ArrayList<UserApply> userApplies = userApplyDao.getUserApplyByRentHouseId(id);
                ...
                <tr>
                    ...
                    <td><%=rentHouseDao.getRentHouseById(userApplies.get(i).getCategoryId()).getRentHousePrice()%></td>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                <%
                    ArrayList<UserApply> userApplies1 = userApplyDao.getAllApplyRentHouse();
