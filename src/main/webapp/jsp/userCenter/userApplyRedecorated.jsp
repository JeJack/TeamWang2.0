                ...
                <%
                    for (int i =0;i<userApplies1.size();){
                        for (int j =0;j<3&&i<userApplies1.size();i++){
                            if ("redecorated".equals(userApplies1.get(i).getApplyCategory())){
                                Redecorated redecorated = redecoratedDao.getRedecoratedById(userApplies1.get(i).getUserApplyId());
                                if (redecorated!=null){
                %>
