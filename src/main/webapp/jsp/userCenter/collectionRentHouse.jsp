            ...
            <div class="row">
                ...
                <%
                    for (int j =0;j<3&&i<userCollectionArrayList.size();i++){
                       if ("renthouse".equals(userCollectionArrayList.get(i).getCollectionCategory())){

                    RentHouseDao rentHouseDao = new RentHouseDao();
                    RentHouse rentHouse = rentHouseDao.getRentHouseById(userCollectionArrayList.get(i).getCollectionCategoryId());
