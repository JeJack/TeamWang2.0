        ...
        <div id="page-inner">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><%=buildingDao.getBuildingById(userApplies1.get(all).getCategoryId()).getBuildingPrice()%></td>
                ...
                <%
                    int i=0;
                        for (int j =0;j<3&&i<userApplies1.size();i++){
                                Building building = buildingDao.getBuildingById(userApplies1.get(i).getCategoryId());
